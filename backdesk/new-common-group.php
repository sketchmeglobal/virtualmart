        ...
        <div class="container-fluid">
          ...
          <div class="row mt-3  d-flex justify-content-center">
            <div class="col-lg-10 ">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="card-title text-primary text-center">New Common Group</div>
                  <hr>
                                ...
                                <input type="hidden" id="count" value="0">
                                  <div class="group_field row">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control removed-form-control-rounded" name="target_group[]">
                                      </div>
                                  </div>
                                  <div class="col-md-3">
                                      <div class="form-group">
                                          <label for="" class="col-form-label">Item</label>
                                          <input type="text" class="form-control removed-form-control-rounded" name="item_group[]">
                                      </div>
                                  </div>
                                  <div class="col-md-3">
                                      <div class="form-group">
                                          <label for="" class="col-form-label">Type/ Style</label>
                                          <input type="text" class="form-control removed-form-control-rounded" name="type_group[]">
                                      </div>
                                  </div>
                                  <div class="col-md-3">
                                  ...
                                  <div class="col-md-9">
                                      <input type="text" class="form-control removed-form-control-rounded" name="material[]" placeholder="Material.">
