...
$sql = "SELECT * FROM user_feedback WHERE product_id = $product_id AND user_id = $user_id";

if(check($sql)['count'] > 0){
$sql1 = "UPDATE user_feedback SET rating = '$rating', review = '$review' WHERE product_id = $product_id AND user_id = $user_id";
update($sql1);
}else{
$sql1 = "INSERT INTO user_feedback SET product_id = $product_id, user_id = $user_id, rating = '$rating', review = '$review'";
insert($sql1);
}
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="order-data-details.php?order=<?=$pid?>" class="btn-info p-2 rounded"><i class="fa fa-edit"></i></a>
                                            |
