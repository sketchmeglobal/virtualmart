...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE tbl_front_images SET category = '$category', status = '$category_status' WHERE id = '$id' ";
    $dataa = update($sql);
    ...
    if($feature_img != ''){
		...
		if (in_array($check_feature_img_ext, $allow_file_ext)) { // feature image accept
			...
			$fertaure_img_update = "UPDATE tbl_front_images SET front_image = '$rename_fetaure_img' WHERE id = '$id' ";
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="col-lg-8">
       ...
       <div class="card">
           <div class="card-body">
           <div class="card-title text-primary text-center">Front Images Edit</div>
           <hr>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-6">
                  ...
                  <img style="height: 150px;display: block;margin-top: 5px;margin-right: 15px;margin-left: auto;" src="../slider-images/<?=$data['all_data']['front_image']?>" alt="" class="">
            </div>
          </div>
