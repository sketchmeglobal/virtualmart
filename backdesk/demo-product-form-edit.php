              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <ul class="nav nav-tabs product_form_tab pb-3 d-flex justify-content-center">
                    ...
                    <li><a data-toggle="tab" href="#menu3">Pricing</a></li>
                        ...
                        <div class="row">
                          ...
                          <div id="menu1" class="tab-pane">
                            <div class="row">
                              ...
                              <div id="menu3" class="tab-pane">
                                ...
                                <?php 
                                $price = [
                                  ['350.00','300.00','30','Multicolor','5.5m','29'],
                                  ['340.00','310.00','20','White','5.5m','20'],
                                  ['370.00','325.00','45','Pink','5.5m','45'],
                                ];
                          ...
                          <?php } ?>
                            <div class="row">
                              ...
                              <div class="form-group col-md-3">
                                <label for="input-26" class="col-form-label">Consultant Seller(%)</label>
                                <input type="text" name="" class="form-control removed-form-control-rounded" id="" placeholder="" required value="1">
                              </div>

                              <div class="form-group col-md-3">
                                <label for="input-26" class="col-form-label">Consultant Supplier(%)</label>
                                <input type="text" name="" class="form-control removed-form-control-rounded" id="" placeholder="" required value="2">
                              </div>
                                ...
                                <input type="text" name="" class="form-control removed-form-control-rounded" id="" placeholder="" required value="20">
                              </div>
                                  <div class="form-group col-md-4">
