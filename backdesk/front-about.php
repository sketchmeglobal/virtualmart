      ...
      <div class="row mt-3">
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-header"><i class="fa fa-table"></i> About</div>
            <div class="card-body">
              ...
              <table id="example" class="table table-bordered">
                ...
                <tbody>
                    <?php 
                    $sql = "SELECT * FROM `tbl_front_about`";
                    $about = single_data($sql)['all_data'];
                    // print_r($about);
                    ?>
                    <tr>
                        <td>1</td>
                        <td><?= substr($about['content'], 0, 50) . '...' ?></td>
                        <td> <i class="fa fa-circle text-<?=$about['status']==0?'warning':'success';?>" aria-hidden="true"></i></td>
                        <td><a href="front-about-form-edit.php?id=<?=$about['id']?>" class="btn-info p-2 rounded"><i class="fa fa-edit"></i></a>
