...
if (isset($_POST['insert'])) {
    ...
    $sql = "INSERT INTO tbl_slider SET muted_text='$muted_text', header='$heading', category='$category', status = '$category_status'";
    $ins = insert($sql);
    $last_id = $ins['count'];
    ...
    if($feature_img != ''){
		...
		if (in_array($check_feature_img_ext, $allow_file_ext)) { // feature image accept
			...
			$fertaure_img_update = "UPDATE tbl_slider SET slider_image = '$rename_fetaure_img' WHERE id = '$last_id' ";
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="col-lg-8">
       ...
       <div class="card">
           <div class="card-body ">
           <div class="card-title text-primary text-center">Slider</div>
           <hr>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-6">
                  <input type="text" name="muted_text" class="form-control form-control-rounded" placeholder="Small muted text">
            </div>
          </div>
          <div class="form-group row">
            <label for="input-26" class="col-sm-6 col-form-label">Catchy Heading</label>
            <div class="col-sm-6">
                  <input type="text" name="heading" class="form-control form-control-rounded" placeholder="Catchy Heading">
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-6">
                ...
                ?>
                      <option value="<?=$pc['p_cid']?>"><?= $pc['p_c_name'] ?></option>
                <?php } ?>
