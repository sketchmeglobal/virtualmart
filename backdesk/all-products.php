...
$query = "SELECT phid, ph_title,ph_status,p_cat_name,c_cat_name,ph_feature_img FROM tbl_product_hdr
JOIN vendors ON tbl_product_hdr.vendor_id = vendors.id
JOIN users ON users.vendor_id = vendors.id
WHERE tbl_product_hdr.ph_status !=2 &&  tbl_product_hdr.row_status = 1 && tbl_product_hdr.ph_upload_type !='DRAFT' && vendors.row_status = 1
                        ...
                        <div class="card">
                            <div class="card-body table-responsive">
                                ...
                                <div class="card-title d-flex justify-content-between">
                                    ...
                                    <!-- <a class="btn btn-success" href="new-product.php">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a title="Add to Stock" class="btn btn-info" href="vendor-product-approval.php?id=<?=encode($ap['phid'])?>">
                                                <i class="zmdi zmdi-edit"></i>
                                            </a>
                                            <a class="btn btn-danger" href="?del=<?=$ap['phid'] ?>" onclick="return confirm('Are you sure want to delete?')">
