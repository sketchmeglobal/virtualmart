          ...
          <div class="row mt-3">
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="card-header"><i class="fa fa-table"></i> Pending Withdrawal Data</div>
                <div class="card-body">
                  <div class="table-responsive pt-5">
                    <table id="example" class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        WHERE tbl_withdrawal.withdrawal_status = 0
                        ORDER BY tbl_withdrawal.withdrawal_id ASC";
                        $data = all_data($query);
                        if ($data['data']==true) {
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="change-withdrawal-status.php?wid=<?=$od['withdrawal_id'] ?>" class="btn btn-success">Change</a>
                          </td>
                          <?php } }else{ ?>
                          <tr>
