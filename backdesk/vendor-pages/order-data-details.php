                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                     ...
                     <form class="row" action="cores/update-order-product-submit-from-vendor.php" method="post">
                      <input type="hidden" name="order_id" value="<?=$data[0]['order_dtl_id']?>">
                       ...
                       <div class="form-group col-md-4">
                         ...
                         <input type="" name="shipping_agent_name" class="form-control" value="<?=$data[0]['shipping_agent_name']?>" readonly>
                       </div>
