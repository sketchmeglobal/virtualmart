...
echo '<script>window.location.href="?page=order-data-referral"</script>';
}
$order_detail_query_group = "SELECT * FROM tbl_order_dtl
JOIN tbl_order_hdr ON tbl_order_dtl.order_hdr_id = tbl_order_hdr.order_hdr_id
WHERE tbl_order_dtl.order_hdr_id = '$pid' && tbl_order_hdr.consultant_id = '".$_SESSION['id']."'
                    ...
                    <div class="col-md-12">
                      <table class="table-bordered w-100">
                        <tr>
                          ...
                          <th>QTY</th>
                          <th>Price</th>
                          <th class="float-right w-100">Total</th>
                        </tr>
                        <?php
                        ...
                        <tr>
                          ...
                          <td class="float-right w-100"><?=number_format($value['product_qty']*$value['product_price'],2)?></td>
                        </tr>
                        <?php } ?>
                        <tr>
