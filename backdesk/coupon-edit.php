...
$query = "SELECT * FROM tbl_coupons WHERE coupon_id = '$cid' ";
$data = single_data($query)['all_data'];
        ...
        <div class="container-fluid">
          ...
          <div class="row mt-3  d-flex justify-content-center">
            <div class="col-lg-10 ">
              <div class="card">
                <div class="card-body">
                  <div class="card-title text-primary text-center">Coupon Edit</div>
                  <hr>
                  <form action="cores/update-cupon-code.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <input type="text" name="coupon_code" class="form-control form-control-rounded" id="input-26" placeholder="Enter COUPON CODE" required value="<?=$data['coupon_code']?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <input type="text" name="coupon_amount" class="form-control form-control-rounded" id="input-26" placeholder="Enter COUPON AMOUNT" required value="<?=$data['amount']?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <select name="coupon_type" id="" class="form-control form-control-rounded">
                          <option value="FIXED" <?= ($data['coupon_type']=='FIXED') ? 'selected':''; ?>>FIXED</option>
                          <option value="PERCENTAGE" <?= ($data['coupon_type']=='PERCENTAGE') ? 'selected':''; ?>>PERCANTAGE</option>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <select name="allowed_products[]" id="allowed_products" class="form-control form-control-rounded select2_1" multiple onchange="allow_product();">
                          ...
                          ?>
                          <option value="<?=$ap['phid']?>"
                            <?php 
                            if (in_array($ap['phid'], explode(',', $data['allowed_products']))) {
                              echo 'selected';
                            }
                             ?>
                            ><?=$ap['ph_title']?></option>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <select name="disallowed_products[]" id="disallowed_products" class="form-control form-control-rounded select2_1" multiple onchange="disallow_product();">
                          ...
                          <option value="<?=$ap['phid']?>"
                            <?php 
                            if (in_array($ap['phid'], explode(',', $data['disallowed_products']))) {
                              echo 'selected';
                            }
                             ?>
                            ><?=$ap['ph_title']?></option>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <input type="number" name="max_limit" class="form-control form-control-rounded" id="input-26" placeholder="max limit" required value="<?=$data['max_limit']?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <input type="date" name="expiary_date" class="form-control form-control-rounded" id="input-26" placeholder="" required value="<?=$data['expiary_date']?>">
                      </div>
                    </div>
              ...
              $.ajax({
                ...
                success:function(data){
                  if (data==1) {
                    ...
                    if (allowed_products >0 && disallowed_products > 0) {
                      $('#products_disallowed_dis').html('Product already added');
                    }
