  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row mt-3">
        ...
        <div class="col-lg-12">
          <div class="card">
            <!--<p><a href="newsletter-form.php" class="btn btn-success btn-md col-1">+ Add New</a></p>-->
            <div class="card-header"><i class="fa fa-table"></i> Newsletter</div>
            <div class="card-body">
              ...
              <table id="example" class="table table-bordered">
                ...
                <tbody>
                                            <?php 
                                                ...
                                                $newsletter_data = all_data($query);
                                                
                                                foreach ($newsletter_data['all_data'] as $key => $value) {
                                                ?>
                                                <tr>
                                                    <td><?=++$key;?></td>
