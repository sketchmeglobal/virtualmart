<?php
if (isset($_POST['subscribe_mail_btn'])) {

extract($_POST);

$search = "SELECT * FROM tbl_newsletter WHERE email_id ='".$subscribe_mail . "'";
$count = (check($search)['count']);

if($count == 0){
$sql = "INSERT INTO tbl_newsletter SET email_id ='".$subscribe_mail . "'";
$ins = insert($sql);
...
<input name="subscribe_mail" type="email" class="form-control" placeholder="Enter your Email Address" aria-label="Email Adress" required>
<div class="input-group-append">
<button name="subscribe_mail_btn" class="btn" type="submit">Subscribe</button>
...
<h4 class="font-weight-bold"><?=site_name?></h4>
...
<li><a href="https://sketchmeglobal.com/404.html/">About Sreyhva</a></li>
<li><a href="#">How to shop on Sreyhva</a></li>
<li><a href="faq.html">FAQ</a></li>
<li><a href="https://sketchmeglobal.com/404.html/">Contact us</a></li>
...
<div class="container-fluid">
<p class="footer-copyright">Copyright © 2019 Sreyhva Store. All Rights Reserved.</p><!-- End .footer-copyright -->
